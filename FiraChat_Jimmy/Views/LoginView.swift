...
//        button.layer.borderColor = #colorLiteral(red: 0.2, green: 0.2, blue: 0.2, alpha: 1)
    ...
    lazy var registerButton: UIButton = {
        ...
        let attributedTitle = NSMutableAttributedString(string: "계정이 없으신가요? ", attributes: [.font: UIFont.systemFont(ofSize: 14), .foregroundColor: UIColor.kakaoBrown ?? UIColor.systemBrown])
        attributedTitle.append(NSMutableAttributedString(string: "회원가입하기", attributes: [.font: UIFont.boldSystemFont(ofSize: 14), .foregroundColor: UIColor.kakaoBrown ?? UIColor.systemBrown]))
    ...
    private func setup() {
        ...
        [stackView, registerButton].forEach { self.addSubview($0) }
    }
